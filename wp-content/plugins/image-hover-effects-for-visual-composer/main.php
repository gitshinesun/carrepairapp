...
class VC_IHEC
{
	...
	function showVcVersionNotice(){
	    ...
	    <div class="notice notice-warning is-dismissible">
	        <p>Please install <a href="https://codecanyon.net/item/visual-composer-page-builder-for-wordpress/242431?ref=nasir179125">Visual Composer</a> to use Image Hover Effects.</p>
	    </div>
	    <?php
	}
