...
if ( ! class_exists( 'Login_Designer_Customizer' ) ) :
	...
	class Login_Designer_Customizer {
		...
		public static function get_background_images() {
			...
			$backgrounds = array(
				'none' => array(
					'title' => esc_html__( 'None', 'login-designer' ),
					'image' => esc_url( $image_dir ) . '00.jpg',
				),
				'bg_01' => array(
					'title' => esc_html__( '01', 'login-designer' ),
					'image' => esc_url( $image_dir ) . '01-sml.jpg',
				),
				'bg_02' => array(
					'title' => esc_html__( '02', 'login-designer' ),
					'image' => esc_url( $image_dir ) . '02-sml.jpg',
				),
				'bg_03' => array(
					'title' => esc_html__( '03', 'login-designer' ),
					'image' => esc_url( $image_dir ) . '03-sml.jpg',
				),
				'bg_04' => array(
					'title' => esc_html__( '04', 'login-designer' ),
					'image' => esc_url( $image_dir ) . '04-sml.jpg',
				),
				'bg_05' => array(
					'title' => esc_html__( '05', 'login-designer' ),
					'image' => esc_url( $image_dir ) . '05-sml.jpg',
				),
				'bg_06' => array(
					'title' => esc_html__( '06', 'login-designer' ),
					'image' => esc_url( $image_dir ) . '06-sml.jpg',
				),
				'bg_07' => array(
					'title' => esc_html__( '07', 'login-designer' ),
					'image' => esc_url( $image_dir ) . '07-sml.jpg',
				),
				'bg_08' => array(
					'title' => esc_html__( '08', 'login-designer' ),
					'image' => esc_url( $image_dir ) . '08-sml.jpg',
				),
				'bg_09' => array(
					'title' => esc_html__( '09', 'login-designer' ),
